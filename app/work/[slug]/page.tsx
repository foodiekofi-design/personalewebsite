...
const caseStudies: Record<string, CaseStudy> = {
  ...
  "film-finder-brand": {
    ...
    tldr: "As co-founder I designed Film Finder's full visual identity, then made it hold across every surface: the app, the website, merch and social. One coherent system that lets a small startup look and feel far bigger than it is.",
    metrics: [
