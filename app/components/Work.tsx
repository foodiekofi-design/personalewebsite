...
const projects: {
...
}[] = [
  {
    ...
    description: "Grew a film-discovery app I co-founded from 20 to 169 weekly active users by rebuilding discovery and onboarding, plus 2,000 newsletter subscribers.",
