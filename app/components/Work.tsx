...
const projects: {
...
}[] = [
  {
    ...
    description: "Grew a film-discovery app I co-founded from 20 to 70-100 weekly active users by rebuilding discovery and onboarding, plus 2,000 newsletter subscribers.",
  ...
  },
  {
    ...
    description: "Designed how teams safely deploy Salesforce AI agents, now live in Gearset, and prototyped the front end in the product's real code.",
  ...
  },
  {
    ...
    description: "Shipped Beauhurst's first native CRM integration to 73 clients in six months, 46% past target.",
  ...
  },
  {
    ...
    description: "Lifted subscription orders 20% by bringing charge and mortgage data into the platform, with 3,600 views in the first three months.",
  ...
  },
  {
    ...
    description: "Designed an accessible transport chatbot whose research shaped the voice service Translink shipped next, cutting call volume.",
